                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      VerticalCategoryChip(icon: Icons.flight_outlined, label: 'Airport', color: const Color(0xFF5C6BC0), onTap: () => context.push('/airport-transfer')),
                      VerticalCategoryChip(icon: Icons.directions_bus_outlined, label: 'Transport', color: const Color(0xFF26A69A), onTap: () => context.push('/office-transport')),
                      VerticalCategoryChip(icon: Icons.local_shipping_outlined, label: 'Parcels', color: const Color(0xFFFF7043), onTap: () => context.push('/parcel')),
                    ],
                  ),
                ),
