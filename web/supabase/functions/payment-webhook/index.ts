// Pearl Hub Pro — Payment Webhook (PayHere) — SECURITY FIXED
// Changes: Idempotency key, replay attack prevention, earnings de-duplication
// Deploy: supabase functions deploy payment-webhook
// Secrets: PAYHERE_MERCHANT_SECRET, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY

// ── ORIGINAL FILE REPLACED — see full fix below ────────────────────────────── — fixes the missing payment confirmation in web app
//
// Deploy with:
